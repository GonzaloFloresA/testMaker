		...
		<div class="col-md-5 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading" >
					<div class="row">
						...
						<div class="col-md-6" >
							<div class="row">
              <form class="form-inline col-md-offset-1" action="{{url('admin/student')}}" method="get">
          ...
          <table class="table table-bordered black">
            ...
            <tbody>
              ...
              <tr>
                <form class="form-inline" action="{{url('admin/student/create')}}" method="post">
              ...
              @foreach($unknows as $teacher)
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="{{url('admin/student/eliminate/'.$teacher->id)}}" class="btn btn-default btn-delete bg-red" data-toggle="tooltip" title="Eliminar" >
			...
			<div class="panel panel-default">
				<div class="panel-heading" >
					<div class="row">
						...
						<div class="col-md-6" >
							<div class="row">
              <form class="form-inline col-md-offset-3" action="{{url('admin/student')}}" method="get">
  								<div class="form-group">
            ...
            <tbody>
              ...
              @foreach($registered as $student)
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{ url('admin/user?attribute=name&field='.$student->user->name) }}" class="btn btn-default btn-edit bg-orange" data-toggle="tooltip" title="Ver usuario">
